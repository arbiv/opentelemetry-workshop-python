...
provider = TracerProvider(resource=Resource.create({SERVICE_NAME: "yosef-workshop-man"}))
...
metric_reader = PeriodicExportingMetricReader(ConsoleMetricExporter(), export_interval_millis=30*1000)
